...
// Espelha os botões que a interface mostra (Portal CPA: src/lib/planos.js,
// botoesDoPlano) — qualquer botão novo precisa de uma linha nova aqui.
function podeTransitar(opts: {
  ...
  if (papel === 'coordenador' && escopoCoordenador) {
    if (statusAtual === 'aguardando_coordenador' && novoStatus === 'enviado') return true // aprova o item do auxiliar
